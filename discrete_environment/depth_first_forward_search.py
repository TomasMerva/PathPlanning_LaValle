...
def DepthFirstForwardSearch(draw, start, goal):
    ...
    while len(open_set) > 0:                                # line 2
        ...
        current_state = open_set.pop()                      # line 3  -> LIFO Buffer
        ...
        for event in pygame.event.get():
            ...
            if event.type == pygame.KEYDOWN:
                ...
                if event.key == pygame.K_SPACE and start_node and goal_node:
                    ...
                    DepthFirstForwardSearch(lambda: world.draw(), start_node, goal_node)
                # reset environment
